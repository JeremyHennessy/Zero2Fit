...
assert_dom 'Health &amp; data' 'Build 036 Devices heading'
...
assert_dom 'Your devices and private data' 'Build 036 Devices title'
...
assert_dom 'Today’s nutrition' 'Build 036 Fuel heading'
...
assert_dom 'Find a food' 'Build 036 food-search heading'
...
assert_dom 'One-browser core infrastructure acceptance only.'
assert_dom './build024.css'
assert_dom 'id="z26ActivationGuide"' 'Build 026 activation guide'
assert_dom 'id="z26ActivationGuide"' 'Build 026 activation guide'
assert_dom 'Finish setup' 'Build 036 activation heading'
...
assert_dom 'id="z28HealthKitEvidence"' 'Build 028 HealthKit evidence'
assert_dom 'Verify your health sources' 'Build 036 HealthKit heading'
