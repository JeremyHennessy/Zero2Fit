...
assert_dom 'id="z25ActivationGuide"' 'Build 025 activation guide'
assert_dom 'Activation guide · Build 025'
...
if grep -q 'Zero2Fit Build 022 loader failed to load\|Zero2Fit Build 022 private photo continuity failed to load\|Zero2Fit Build 022/024 private continuity failed to load\|Zero2Fit Build 022/024/025 private continuity failed to load' "$DOM_FILE"; then echo 'Build 022/024/025 private continuity modules failed in browser.' >&2; exit 1; fi

echo "Browser smoke passed: ${EXPECTED_EXERCISES} exercises, ${EXPECTED_MET_ACTIVITIES} MET activities, training, guided workout execution + private set/load continuity, devices, Build 024 private-store acceptance + Build 025 cross-browser/physical guide, clean iPhone UI, Fuel + food lookup + private sync, adaptive/personal intelligence, RPG adventure, private progress-photo continuity, PWA/productization, and private-sync shell rendered."
