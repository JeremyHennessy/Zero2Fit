...
assert_dom 'Connected health' 'Build 038 Devices heading'
...
assert_dom 'Your health stack' 'Build 038 Devices title'
...
assert_dom 'Find food' 'Build 038 food-search heading'
...
assert_dom 'id="z26ActivationGuide"' 'Build 026 activation guide'
assert_dom 'Finish setup' 'Build 038 activation heading'
...
assert_dom 'Match your real sources' 'Build 038 HealthKit heading'
