...
const SHELL = [
  ...
  './zero2fit-config.js', './app.js', './storage.js', './remote-sync.js', './ingestion.js', './device-core.mjs', './training-core.mjs', './adaptive-core.mjs', './intelligence-core.mjs', './adventure-core.mjs', './adventure-visual-core.mjs', './photo-core.mjs', './photo-sync-core.mjs', './acceptance-core.mjs', './activation-guide-core.mjs', './healthkit-evidence-core.mjs', './workout-execution-core.mjs', './nutrition-core.mjs', './food-lookup-core.mjs', './workout-sync-core.mjs',
  './build003-integration.js', './build004-integration.js', './build007-adventure.js', './build008-photos.js', './build008-device-sync.js', './build009-adaptive.js', './build010-intelligence.js', './build011-adventure.js', './build012-productization.js', './build014-workout-execution.js', './build016-adventure-visual.js', './build017-fuel.js', './build018-food-lookup.js', './build019-fuel-sync.js', './build021-workout-sync.js', './build022-loader.js', './build022-photo-sync.js', './build022-copy.js', './build024-private-acceptance.js', './build026-activation-guide.js', './build026-qa-focus.js', './build028-healthkit-evidence.js', './build028-verification-guard.js', './build028-qa-focus.js',
