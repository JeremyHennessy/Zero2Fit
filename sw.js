// Supersedes zero2fit-shell-v24-private-acceptance (which superseded zero2fit-shell-v22-photo-sync and zero2fit-shell-v21-workout-sync).
const CACHE = 'zero2fit-shell-v26-activation-guide';
const SHELL = [
  './', './index.html', './styles.css', './build002.css', './build003.css', './build004.css', './build006.css', './build007.css', './build012.css', './build014.css', './build016.css', './build017.css', './build018.css', './build019.css', './build021.css', './build022.css', './build024.css', './build026.css',
  './zero2fit-config.js', './app.js', './storage.js', './remote-sync.js', './ingestion.js', './device-core.mjs', './training-core.mjs', './adaptive-core.mjs', './intelligence-core.mjs', './adventure-core.mjs', './adventure-visual-core.mjs', './photo-core.mjs', './photo-sync-core.mjs', './acceptance-core.mjs', './activation-guide-core.mjs', './workout-execution-core.mjs', './nutrition-core.mjs', './food-lookup-core.mjs', './workout-sync-core.mjs',
  './build003-integration.js', './build004-integration.js', './build007-adventure.js', './build008-photos.js', './build008-device-sync.js', './build009-adaptive.js', './build010-intelligence.js', './build011-adventure.js', './build012-productization.js', './build014-workout-execution.js', './build016-adventure-visual.js', './build017-fuel.js', './build018-food-lookup.js', './build019-fuel-sync.js', './build021-workout-sync.js', './build022-loader.js', './build022-photo-sync.js', './build022-copy.js', './build024-private-acceptance.js', './build026-activation-guide.js', './build026-qa-focus.js',
