...
const SHELL = [
  ...
  './build003-integration.js', './build004-integration.js', './build007-adventure.js', './build008-photos.js', './build008-device-sync.js', './build009-adaptive.js', './build010-intelligence.js', './build011-adventure.js', './build012-productization.js', './build014-workout-execution.js', './build016-adventure-visual.js', './build017-fuel.js', './build018-food-lookup.js', './build019-fuel-sync.js', './build021-workout-sync.js', './build022-loader.js', './build022-photo-sync.js', './build022-copy.js', './build024-private-acceptance.js', './build026-activation-guide.js', './build026-qa-focus.js', './build028-healthkit-evidence.js', './build028-verification-guard.js', './build028-qa-focus.js', './build031-activation-handoff.js', './build040-blue-orange-ui.js', './build042-daily-guidance.js', './build043-usage-measurement.js',
